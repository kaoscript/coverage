...
module.exports = function(__ks_0, __ks___ks_0) {
	...
	__ks_Array.__ks_func_pushUniq_0 = function(...args) {
		__ks_coverage["/fixtures/compile/require.alt.roe.ks"].f[2]++;
		__ks_coverage["/fixtures/compile/require.alt.roe.ks"].s[4]++;
		if(args.length === 1) {
		...
		__ks_coverage["/fixtures/compile/require.alt.roe.ks"].s[10]++;
		return this;
	};
	...
	__ks_coverage["/fixtures/compile/require.alt.roe.ks"].s[11]++;
	return {
		Array: Array,
