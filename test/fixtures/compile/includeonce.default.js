...
module.exports = function() {
	...
	__ks_String.__ks_func_lines_0 = function(emptyLines) {
		...
		if(this.length === 0) {
			...
			if(emptyLines) {
				...
				return (__ks_coverage["/fixtures/compile/_string.ks"].b[3][0]++, this.match(/[^\r\n]+/g)) || (__ks_coverage["/fixtures/compile/_string.ks"].b[3][1]++, []);
			}
		}
	};
	...
	__ks_coverage["/fixtures/compile/includeonce.default.ks"].s[2]++;
	return {
		String: String,
