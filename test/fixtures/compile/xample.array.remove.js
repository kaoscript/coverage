...
module.exports = function() {
	...
	__ks_Array.__ks_func_remove_0 = function(...items) {
		...
		if(items.length === 1) {
			...
			for(let i = Operator.subtraction(this.length, 1); i >= 0; --i) {
				if(this[i] === item) {
