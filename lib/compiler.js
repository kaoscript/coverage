...
module.exports = function() {
	...
	function $constructor(members, data, coverage, coverageName, file, node) {
		...
		var fields = {};
		for(var __ks_0 = 0, __ks_2 = members.length, member; __ks_0 < __ks_2; ++__ks_0) {
	...
	var $expressions = (__ks_0 = {}, __ks_0[NodeKind.ArrayComprehension] = function(data, coverage, coverageName, file, node) {
		...
		data.properties = [];
		for(var __ks_0 = 0, __ks_3 = properties.length, property; __ks_0 < __ks_3; ++__ks_0) {
	...
	function $sequence(init, data, coverage, coverageName, file, node) {
		...
		if(data.kind === NodeKind.SequenceExpression) {
			...
			for(var __ks_0 = 0, __ks_4 = expressions.length, expression; __ks_0 < __ks_4; ++__ks_0) {
	...
	var $statements = (__ks_0 = {}, __ks_0[NodeKind.BreakStatement] = function(data, coverage, coverageName, file, node) {
		...
		data.members = [];
		for(var __ks_0 = 0, __ks_5 = members.length, member; __ks_0 < __ks_5; ++__ks_0) {
			member = members[__ks_0];
			var __ks_6 = member.kind;
			if(__ks_6 === NodeKind.FieldDeclaration) {
			...
			else if(__ks_6 === NodeKind.MethodDeclaration) {
			...
			else if(__ks_6 === NodeKind.MacroDeclaration) {
				data.members.push(member);
			}
			else {
		...
		var properties = data.properties;
		data.properties = [];
		for(var __ks_0 = 0, __ks_7 = properties.length, property; __ks_0 < __ks_7; ++__ks_0) {
			property = properties[__ks_0];
			var __ks_8 = property.kind;
			if(__ks_8 === NodeKind.FieldDeclaration) {
			...
			else if(__ks_8 === NodeKind.MethodDeclaration) {
	...
	var CoverageModule = Helper.class({
		...
		__ks_func_toFragments_0: function() {
			...
			for(var __ks_0 = 0, __ks_9 = this._coverages.length, coverage; __ks_0 < __ks_9; ++__ks_0) {
		...
		__ks_func_toCoverageFragments_0: function(fragments, coverage) {
			...
			for(var i = 1, __ks_0 = coverage.branchMap.length; i <= __ks_0; ++i) {
				...
				line.code("\"" + i + "\":[");
				for(var j = 0, __ks_10 = coverage.branchMap[i - 1].locations.length; j < __ks_10; ++j) {
					if(j !== 0) {
						line.code(",");
					}
					line.code("0");
