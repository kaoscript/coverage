...
module.exports = function() {
	...
	var $increment = {
		branch: function(bid, eid, coverageName, data, file, node) {
			if(arguments.length < 6) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 6)");
			}
	...
	function $location() {
		if(arguments.length === 2) {
			if(Type.isObject(arguments[1])) {
				var __ks_i = -1;
				var data = arguments[++__ks_i];
				if(data === void 0 || data === null) {
					throw new TypeError("'data' is not nullable");
				}
				var location = arguments[++__ks_i];
				if(location === void 0 || location === null) {
					throw new TypeError("'location' is not nullable");
				}
				...
				var lineStart = arguments[++__ks_i];
